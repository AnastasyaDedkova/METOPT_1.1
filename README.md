...
* Автоматически:
  ...
  * Строит вспомогательную задачу (фаза 1)
  * Решает основную задачу (фаза 2)
* Выводит:
...
### Проверка обработки свободных переменных
